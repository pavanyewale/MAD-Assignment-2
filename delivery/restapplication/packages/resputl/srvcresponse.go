...
//ResponseCustomError custom error which requires error as input
func ResponseCustomError(err error) SrvcRes {
	//err := errors.
	//return SrvcRes{}
...
//ResponseInternalError template for internal error response
func ResponseInternalError() SrvcRes {
	//err := errors.
	//return SrvcRes{}
	var inf EmptyStruct
